...
- 2024-12-18: Исправлена работа бота на Railway
  - Удалена зависимость от локального файла welcome.png (теперь работает везде)
  - Исправлена обработка Language Choice (теперь правильно редактирует текстовые сообщения)
  - Реализована автоматическая детекция Railway по наличию DATABASE_URL
  - На Railway бот теперь использует Webhook режим вместо Polling
- Улучшено приветственное сообщение /start с полным описанием
